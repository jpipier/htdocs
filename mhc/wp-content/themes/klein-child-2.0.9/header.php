	...
	<header id="header" class="site-header" role="banner">
		...
		<div class="container">
			<div class="row">
				...
				<div id="bp-klein-user-bar-action " class=" logIn right">
					<div class="pull-right <?php if( !is_user_logged_in() ){ echo 'logOut'; } ?> ">
						<?php if( is_user_logged_in() ){ ?>
							...
							<?php if( function_exists('bp_core_get_user_domain' ) ){ ?>
								<a id="klein-top-bp-profile-link" class="btn btn-primary" href="<?php echo bp_core_get_user_domain( $current_user->ID );?>" title="<?php _e('My Profile','klein'); ?>">
									...
									<a id="klein-top-updates-btn" class="btn btn-primary" title="Updates" href="#">
										<i class="glyphicon glyphicon-chevron-down"></i>
									</a>
								<?php klein_user_nav(); ?>
							<?php } ?>
						<?php }else{ ?>
							<a data-toggle="modal" id="klein-login-btn" class="btn btn-primary" href="#klein_login_modal" title="<?php _e( 'Login', 'klein' ); ?>"><i class="icon-lock"></i> <?php _e( 'Choicer ?', 'klein' ); ?></a>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											...
											<div id="klein-modal-body" class="left">
											...
											<div class="left modal-text">
												<div class="content-modal-text">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
													<h3><?php echo __('Access the club’s secret evaluations and make yours'); ?></h3>
													<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/img-log.png" alt="">
													<p><?php echo __('Nulla orci lacus, eleifend eu justo sed, iaculis euismod nisi. Aenean condimentum felis ac lorem volutpat vestibulum. Quisque blandit vestibulum ante in sagittis.'); ?></p>
													<span class="btn-mhc btn-logIn"><a href="" class="white"><?php echo __('Request for your pass'); ?></a></span>
												</div>
